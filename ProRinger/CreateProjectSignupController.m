//
//  CreateProjectSignupController.m
//  ProRinger
//
...
@interface CreateProjectSignupController ()

@end

@implementation CreateProjectSignupController
...
- (void)viewDidLoad {
    ...
    [header Appheader_sideMenu_Footer_Load:self HeaderLeftBtn:@"back" HeaderRightBtn:@"home" HeaderText:_header_str Footer:NO];
      ...
      progress_lbl.frame = CGRectMake(0, progress_lbl.frame.origin.y, self.view.frame.size.width/2, 2);
    
    
    header_label.text=_headerlabel_str;
    
    for (UITextField *text in signup_scroll.subviews)
    {
